...
const char name = 'a';              // t.kind==number means that t is a name token
const char let = 'L';               // t.kind==number means that t is a declaration token
    ...
    switch (ch) {
        ...
        default: // handles variable names and keywords
            if (isalpha(ch)) { // a name must start with an alphabetic character
                ...
                // Continue reading while the characters are alphabetic or digits
