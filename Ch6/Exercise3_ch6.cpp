...
double define_name(string var, double val, bool is_constant) 
...
// declare a variable called "name” with the initial value "expression”
{
    ...
    if(t.kind == constant){
        define_name(var_name,d,is_constant); // constant name defined in the var_table
        return d;
    }
    define_name(var_name,d,!is_constant); // define the variable and add its name and associated numerical value to the var_table
